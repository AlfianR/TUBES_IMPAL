  ...
  <section id="container" >
     ...
     <section id="main-content">
          <section class="wrapper">
			<?php
				include_once 'class.barang.php';  $barang = new Barang(); // Checking for user logged in or not

				 if (isset($_REQUEST['submit'])){
					extract($_REQUEST);
					$register = $barang->reg_barang($nama_barang, $status_barang);
					if ($register) {
				...
				<ul class="nav center top-menu">
                    ...
                    <li><a class="logout" href="/SistemInventarisBarang/adminpengelola/databarang.php">Input Data Lainnya</a></li>
            	</ul>
            </div>
		</section>
	</section>
